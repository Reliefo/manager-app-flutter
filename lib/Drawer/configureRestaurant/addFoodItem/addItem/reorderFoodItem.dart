...
class ReorderFoodItem extends StatefulWidget {
  final List<MenuFoodItem> itemList;
  ...
  @override
  _ReorderFoodItemState createState() => _ReorderFoodItemState();
}

class _ReorderFoodItemState extends State<ReorderFoodItem> {
